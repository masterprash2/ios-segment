...
Pod::Spec.new do |s|
  s.name             = 'PowerAdapter'
  s.version          = '0.1.0'
  s.summary          = 'A short description of PowerAdapter.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/masterprash2/PowerAdapter'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'masterprash2' => 'prashant.rathore' }
  s.source           = { :git => 'https://github.com/masterprash2/PowerAdapter.git', :tag => s.version.to_s }
